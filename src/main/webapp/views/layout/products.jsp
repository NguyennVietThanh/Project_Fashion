...
<div class="content">
	...
	<div class="container mt-4">
		<a href=""><img
			src="https://lh3.googleusercontent.com/0euzDgfadytUI5kSBZo3dii5kzFPu9DFBC4sqlofyoFC0aXXKFdJ2Sk0KX8IPRSJ597nxrnl8GMP-PP7kRWOKWYmm51LhSmp=w1232-rw"
			alt="" class="w-100 item-rounded"></a>
	</div>
			...
			<div class="card-body" ng-controller="myCtrl">
				<div class="row row-cols-md-4 g-3"
					...
					<div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"
						ng-repeat="laptop in laptop | limitTo : 8">
						<div class="card h-100">
							<a href="#!detail/{{laptop.id}}"><img
							...
							<div class="card-body">
								...
								<a href="#!detail/{{laptop.id}}" class="card-name">Laptop
									ACER Nitro 16 Phoenix AN16-41-R5M4 (NH.QKBSV.003) (Ryzen 5
									7535HS/RAM 8GB/512GB SSD/ Windows 11)</a>
